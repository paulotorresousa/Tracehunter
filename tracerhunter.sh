...
if [[ $EUID -ne 0 ]]; then
        echo -e "\033[1;31m Este script só roda como root. \033 "
        exit 1
fi
...
echo -e "\033[1;95m Listando informações sobre discos e partições... \033"
lsblk >  disk_info.txt
#Coletando conexões de rede
echo -e "\033[1;95m Coletando informações de rede... \033m"
ss > active_connections.txt
netstat > open_ports.txt
#Coleta de processos
echo -e "\033[1;95m Coletando lista de processos... \033i"
ps > process_list.txt
# Coleta de Registros do Sistema
echo -e "\033[1;95m Coletando logs do sistema...  \033m"
...
echo -e "\033[1;95m Coletando arquivos de configuração... \033"
cp -r  /etc  $COLLECTED_DIR/etc_config
#Coleta de lista de arquivos no diretório raiz
echo -e  "\033[1;95m Listando o diretório raiz... \033m"
